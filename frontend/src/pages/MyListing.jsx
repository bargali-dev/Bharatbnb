...
const MyListing = () => {
  ...
  console.log(userData.listing)
  return (
    <div className=" flex items-center justify-center flex-col gap-[50px] relative">
      <div
        className="w-[50px] h-[50px] bg-[red] cursor-pointer absolute top-[120px] left-[80px] rounded-[50%] flex items-center justify-center "
        onClick={() => navigate("/")}
      >
      ...
      <div className="w-[100%] h-[90%] flex items-center justify-center gap-[0px] flex-wrap mt-[90px] ">
